...
internal fun apiLogTime(context: Context, record: ApiLogStore.ApiLogRecord): String = SimpleDateFormat("yyyy-MM-dd HH:mm:ss", LocaleHelper.locale(context)).format(Date(record.timestamp))
