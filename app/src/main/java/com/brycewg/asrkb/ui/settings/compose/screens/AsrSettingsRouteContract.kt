...
internal data class AsrOnlineSettingsRouteState(
    ...
    val onCohereApiKeyChange: (String) -> Unit,
    val cohereModel: String,
    val onCohereModelChange: (String) -> Unit,
    val cohereCustomModelVisible: Boolean,
    val onCohereCustomModelSelected: () -> Unit,
    val cohereCustomModelDraft: String,
    val onCohereCustomModelDraftChange: (String) -> Unit,
    val cohereLanguage: String,
    val onCohereLanguageChange: (String) -> Unit,
